package lesson13Solutions.lesson13Sol2;
    ...
    void doHomework(){
        ...
        try {
            ...
            while (readyCarCount != CARS_COUNT){
                ...
                System.out.printf("%s Готовы %d из %d машин. (Ждем в основном потоке 200 мс)%s\n", BLACK_BOLD_BRIGHT, readyCarCount, CARS_COUNT, RESET);
            ...
            while (readyCarCount != CARS_COUNT){
                // Выводим отладочную информацию
                System.out.printf("%s Машины на финише %d из %d машин. (Ждем в основном потоке 200 мс)%s\n", BLACK_BOLD_BRIGHT, readyCarCount, CARS_COUNT, RESET);
                Thread.sleep(200); // Ждем 200 мс
